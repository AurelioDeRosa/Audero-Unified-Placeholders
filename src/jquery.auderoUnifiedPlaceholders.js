                  ...
                  .on('focus.auderoUnifiedPlaceholders', function () {
                     ...
                     if (this.value === placeholder) {
                        if (this.createTextRange) {
                           ...
                           // The setTimeout() call is needed to fix an issue in Chrome.
                           // See https://code.google.com/p/chromium/issues/detail?id=32865
                           window.setTimeout(function() {
                              try {
                                 // The change of the type is needed because Chrome raises an Exception
                                 // for call to setSelectionRange() on fields type different than "text"
                                 // See https://code.google.com/p/chromium/issues/detail?id=346270
                                 if (that.nodeName === 'INPUT' && that.type !== 'text') {
